...
public class PackageServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            throw new ServletException("Database error occurred: " + ex.getMessage(), ex);
        }
    }
    ...
    private void insertPackage(HttpServletRequest request, HttpServletResponse response)
        ...
        // Create a new Package object without videoQuality
        Package newPackage = new Package(pkgName, description, price, duration, pkgType);
    ...
    private void updatePackage(HttpServletRequest request, HttpServletResponse response)
        ...
        // Create an updated Package object without videoQuality
        Package updatedPackage = new Package(id, pkgName, description, price, duration, pkgType);
